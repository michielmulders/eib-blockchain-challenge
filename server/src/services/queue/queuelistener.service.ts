...
export class QueueListenerService {
   ...
   * @param hlfClient
   */
  constructor(@Inject('IEventService') private webSocketService: IEventService, private hlfClient: HlfClient) {}
  ...
  private getQueryUrl(): Promise<string> {
    return this.sqs
      ...
      .catch((error: AWSError) => {
        return this.createNewQueue().then((result) => {
